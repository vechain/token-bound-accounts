# Contributing to token-bound-accounts

<!-- Find and replace elements that start with '<!--' and remove this line -->

First of all, thank you for considering to contribute to token-bound-accounts! Your help is invaluable to improve the project and make it more useful for the community. This document will guide you through the contribution process and make it easier for you to get started.
